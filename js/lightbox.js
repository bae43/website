...
(function() {
	...
	Lightbox = (function() {
		...
		Lightbox.prototype.sizeContainer = function(orig_imageWidth, orig_imageHeight) {
// 			
			var ratio = orig_imageWidth/orig_imageHeight;
			
			const max_height = 600;
			const max_width = 1100;
			const max_ratio= max_width/max_height;
			
			var imageWidth = orig_imageWidth;
			var imageHeight = orig_imageHeight;
				
// 				
			if(orig_imageHeight > max_height || orig_imageWidth > max_width){
				if (orig_imageWidth >= orig_imageHeight *max_ratio){
