...
(function() {
    ...
    var a = window.StyleFix = {
        link : function(b) {
            ...
            var d = b.href || b.getAttribute("data-href"), e = d.replace(/[^\/]+$/, ""), f = b.parentNode, g = new XMLHttpRequest;
    ...
    (function() {
        var a = {}, b = [], d = {}, e = getComputedStyle(document.documentElement, null), f = document.createElement("div").style, g = function(c) {
            if(c.charAt(0) === "-") {
                b.push(c);
                var d = c.split("-"), e = d[1];
                a[e] = ++a[e] || 1;
        ...
        for(var f in a) {
            var g = a[f], h = g.property, i = f + "(" + g.params + ")";
